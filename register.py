...
def rd():
    if request.method=="POST":
        ...
        for i in range(1,11):
            if i==1:
                n=((i*12)*((i*12)+1))/2
                si=(p*n*(1/12)*(5.25/100))
                am=(p*(i*12))+si
                ind.append(am)
            else:
                n=((i*12)*((i*12)+1))/2
                si=(p*n*(1/12)*(5.15/100))
                am=(p*(i*12))+si
                ind.append(am)
        for i in range(1,11):
            if i==1:
                si=(p*((i*12)*((i*12)+1)/2)*(1/12)*(5/100))
                am=(p*(i*12))+si
                sbi.append(am)
            elif i==2:
                si=(p*((i*12)*((i*12)+1)/2)*(1/12)*(5.1/100))
                am=(p*(i*12))+si
                sbi.append(am)
            elif i==3:
                si=(p*((i*12)*((i*12)+1)/2)*(1/12)*(5.3/100))
                am=(p*(i*12))+si
                sbi.append(am)
            else:
                si=(p*((i*12)*((i*12)+1)/2)*(1/12)*(5.4/100))
                am=(p*(i*12))+si
                sbi.append(am)
        for i in range(1,11):
            if i in range(1,3):
                si=(p*((i*12)*((i*12)+1)/2)*(1/12)*(4.9/100))
                am=(p*(i*12))+si
                hdfc.append(am)
            elif i==3:
                si=(p*((i*12)*((i*12)+1)/2)*(1/12)*(5.15/100))
                am=(p*(i*12))+si
                hdfc.append(am)
            else:
                si=(p*((i*12)*((i*12)+1)/2)*(1/12)*(5.3/100))
